...
def test_recommended_runtime_gemma4_e2b_e4b_is_ik_llama():
    """Gemma 4 E2B and E4B prefer ik_llama for the IQK speedup."""
...
def test_recommended_runtime_gemma4_26b_is_llama_cpp():
    """Gemma 4 26B stays on llama_cpp — f16 KV cache blows the memory budget."""
    assert recommended_runtime_for_model("gemma-4-26B-A4B-it-UD-IQ2_M.gguf") == "llama_cpp"
    assert recommended_runtime_for_model("gemma-4-26B-A4B-it-UD-IQ4_NL.gguf") == "llama_cpp"
